...
if __name__ == "__main__":
    ...
    model = DQN(
        ...
        verbose=1,
        tensorboard_log="logs/intersection_basic/",
    )
    ...
    model.save("models/intersection_basic_dqn_" + current_time + ".zip")
    print("Modell gespeichert unter models/intersection_basic_dqn " + current_time + ".zip")
